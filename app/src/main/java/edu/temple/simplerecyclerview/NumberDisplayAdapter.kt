...
class NumberDisplayAdapter (private val numbers: Array<Int>, val change_text_size: (TextView) -> Unit) : RecyclerView.Adapter<NumberDisplayAdapter.NumberViewHolder>() {
